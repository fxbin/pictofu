...
export const SEO_EXPERIENCES: SeoExperience[] = [
  {
    ...
    faq: [
      ...
      { question: "Does PicTofu upload my camera photos?", answer: "The current PicTofu MVP captures and composes your strip in the browser rather than storing your photos on a PicTofu server." },
    ],
  ...
  },
  {
    ...
    highlights: ["1×4, 1×3, 2×2 and Polaroid-like layouts", "Original, B&W, Warm, Vintage and Y2K filters", "Pastel frames with PicTofu footer branding"],
  ...
  },
  {
    ...
    description: "Try a Korean-style four-cut photobooth online with a warm filter, soft pink frame and browser-based photo strip export.",
    h1: "A soft Korean-style four-cut photobooth",
    eyebrow: "Four cuts, soft color, date-night energy.",
    intro: "This preset starts with the four-cut rhythm people love in Korean photo booths: a warm look, blush frame and fast countdown flow. It is designed for dates, friends and casual portraits without turning the browser into a heavy editor.",
    presetId: "korean-date",
    cta: "Start Korean Date booth ✦",
    highlights: ["Warm four-cut preset", "Blush-pink strip frame", "Fast browser camera flow"],
    howItWorks: ["Open the Korean Date preset with its warm and pink defaults already selected.", "Take four poses as PicTofu counts down each shot.", "Fine-tune the look, then save the finished four-cut strip."],
    faq: [
      { question: "What makes this different from the classic booth?", answer: "The Korean Date route opens a real preset with a warm filter and blush-pink four-cut frame instead of the classic neutral defaults." },
  ...
  },
  {
    ...
    description: "Create a Y2K-inspired photo strip online with saturated color, a lilac frame and a four-shot browser photobooth flow.",
    h1: "Give your photo strip a Y2K flashback",
    eyebrow: "Glossy color. Lilac frame. 2000s mood.",
    intro: "The Y2K Summer preset pushes the strip toward a brighter, punchier look instead of soft film nostalgia. Start with the saturated Y2K filter and lilac frame, then capture four poses for one playful export.",
    presetId: "y2k-summer",
    cta: "Start Y2K Summer booth ✦",
    highlights: ["Saturated Y2K export filter", "Lilac four-cut frame", "Four poses in one PNG"],
    howItWorks: ["Launch with the Y2K filter and lilac frame preselected.", "Take four quick poses with the countdown.", "Keep the Y2K look or edit it before downloading the strip."],
    faq: [
  ...
  },
  {
    ...
    description: "Make a warm vintage photo strip online with faded film tones, a cream frame and local browser PNG export.",
    h1: "Turn four quick poses into a vintage film strip",
    eyebrow: "Warm grain-era mood, without the old camera.",
    intro: "Vintage Film starts from a warmer, slightly faded color treatment and a cream frame. It is for portraits that should feel less glossy and more like a little strip found in a drawer years later.",
    presetId: "vintage-film",
    cta: "Start Vintage Film booth ✦",
    highlights: ["Vintage Canvas filter", "Cream photo-strip frame", "Browser-local PNG composition"],
    howItWorks: ["Open the Vintage Film preset with its faded warm look ready.", "Capture four expressions or poses.", "Adjust the frame or filter if you want, then export one finished strip."],
    faq: [
      { question: "Does PicTofu add a vintage filter to the exported file?", answer: "Yes. The vintage treatment is applied in the Canvas compositor before PNG export." },
  ...
  },
  {
    ...
    description: "Take a cute couple photo strip online with a blush frame, four-shot countdown and browser-local PNG export.",
    h1: "A little online photobooth for two",
    eyebrow: "Date night, anniversary, or just because.",
    intro: "Couple Date keeps the setup simple so two people can focus on posing instead of configuring the editor. It opens with a clean four-cut layout and blush frame that works for dates, anniversaries and everyday couple photos.",
    presetId: "couple-date",
    cta: "Start Couple Date booth ♡",
    highlights: ["Four-cut couple-friendly flow", "Blush frame with clean color", "Download one strip to keep or share"],
    ...
    faq: [
      { question: "Do both people need an account?", answer: "No. PicTofu does not require an account for the current browser photobooth flow." },
  ...
  },
  {
    ...
    description: "Make a best-friend photo booth collage online with a 2×2 layout, lilac frame and four-shot browser camera flow.",
    ...
    highlights: ["2×2 four-photo default", "Lilac frame", "One shareable PNG collage"],
  ...
  },
  {
    ...
    description: "Create a graduation photo strip online with a warm three-cut layout, mint frame and browser-based PNG export.",
    h1: "A graduation photo strip for the end of one chapter",
    eyebrow: "Cap, gown, three poses, done.",
    intro: "Graduation uses a shorter three-cut strip so the result feels more like a keepsake than a long session. The warm filter and mint frame make a light starting point for solo portraits or quick photos with classmates.",
    presetId: "graduation",
    cta: "Start Graduation booth 🎓",
    highlights: ["Three-cut keepsake layout", "Warm filter with mint frame", "Fast browser export after the ceremony"],
